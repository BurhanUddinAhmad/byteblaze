                ...
                <article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col items-start justify-between w-full md:flex-row md:items-center dark:text-gray-600">
                            ...
                            <p className="text-sm">{reading_time_minutes} mins • {new Date(published_at).toLocaleDateString()} </p>
                        ...
                        <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden flex-nowrap dark:bg-gray-100 dark:text-gray-800">
                            ...
                            className="bg-primary rounded-full p-3 text-secondary cursor-pointer hover:bg-opacity-30 duration-1000">
